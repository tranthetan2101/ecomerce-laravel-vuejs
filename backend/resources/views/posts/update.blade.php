...
<h1>create product</h1>
    ...
    @method('PATCH')
        ...
        <div class="form-group row">
            ...
            <div class="col-md-11">
                <a href="#" role="button" data-input="image_url" id="lfm" data-preview="holder" class="btn btn-outline-primary">
                    Choose
               </a>
        ...
        <button type="submit" class="btn btn-outline-success float-md-right">Sửa bài viết</button>
    </form>
    @endsection
    @push('scripts')
